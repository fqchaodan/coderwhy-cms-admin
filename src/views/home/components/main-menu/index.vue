...
<template>
  <el-scrollbar height="100%">
    <div class="w-full h-full flex flex-col items-center bg-slate-4">
      <!--  Logo  -->
      <div class="w-full h-30px flex items-center justify-around p-1">
        <img alt="logo" class="h-full" src="@/assets/image/logo.svg" />
        <div class="font-bold text-[--el-color-primary-text]">Tomato Admin</div>
      </div>
      ...
      <el-menu
        ...
        class="w-full !bg-slate-3 rounded select-none"
        popper-effect="light"
        router
      >
